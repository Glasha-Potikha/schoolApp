...
public class StudentControllerWebMvcTest {
    ...
    public void testEditStudent_success() throws Exception {
        ...
        mockMvc.perform(put("/student")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.name").value("Обновлён"));
    }
    ...
    public void testFilterForAge() throws Exception {
        Student s1 = new Student(11, "Гарри", 1L);
        Student s2 = new Student(11, "Рон", 2L);
        Mockito.when(studentService.filterForAge(11)).thenReturn(List.of(s1, s2));

        mockMvc.perform(get("/student/filter").param("years", "11"))
                .andExpect(status().isOk())
