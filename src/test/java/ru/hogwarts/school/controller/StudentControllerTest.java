...
public class StudentControllerTest {
    ...
    public void testGetStudentById() throws Exception {
        ...
        mockStudent.setName("Тест Тестович");

        Mockito.when(studentService.getStudent(1L)).thenReturn(mockStudent);
        ResponseEntity<Student> response = this.restTemplate.getForEntity("http://localhost:" + port + "/student/1", Student.class);

        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isNotNull();
        assertThat(response.getBody().getName()).isEqualTo("Тест Тестович");
    }
    ...
    public void testFilterForAge() throws Exception {
        ...
        ResponseEntity<List<Object>> response = restTemplate.exchange("http://localhost:" + port + "/student/filter?years=11",
                HttpMethod.GET,
                null,
    ...
    public void testFindStudentsByAgeBetween() throws Exception {
        ...
        Mockito.when(studentService.findStudentsByAgeBetween(10, 14)).thenReturn(mockStudents);

        ResponseEntity<List<Object>> response = restTemplate.exchange("http://localhost:" + port + "/student/between?min=10&max=14",
                HttpMethod.GET,
                null,
                new ParameterizedTypeReference<List<Object>>() {
                }
    ...
    public void testGetStudentFaculty() {
        ...
        facultyTest.setName("Тестор");
        Mockito.when(studentService.getStudentFaculty(1)).thenReturn(facultyTest);
        ResponseEntity<Faculty> response = restTemplate.getForEntity("http://localhost:" + port + "/student/faculty/1", Faculty.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isNotNull();
    ...
    public void testCreateStudent() throws Exception {
        ...
        assertThat(response.getName()).isEqualTo("Один Тестович");
    }
    ...
    public void testEditStudent() throws Exception {
        ...
        editedStudent.setName("Один Тестович");
    ...
    public void testEditStudent_notFound() throws Exception {
        Student student = new Student();
        student.setId(8L);
        student.setName("Окто Ненайденный");
    ...
    public void testDeleteStudent() throws Exception {
        Student student = new Student();
        student.setId(1L);
        student.setName("Один Удаляемый");
        ...
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isNotNull();
        assertThat(response.getBody().getName()).isEqualTo("Один Удаляемый");
    }
